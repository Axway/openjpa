...
public class java$util$HashMap$proxy extends HashMap
  implements ProxyMap
{
  ...
  public java$util$HashMap$proxy(int paramInt, float paramFloat)
  {
    super(paramInt, paramFloat);
  }

  public java$util$HashMap$proxy(int paramInt)
  {
    super(paramInt);
  }

  public java$util$HashMap$proxy()
  {
  }

  public java$util$HashMap$proxy(Map paramMap)
  {
    super(paramMap);
  }
  ...
  {
    return new HashMap((Map)paramObject);
  }
 ...
 * Qualified Name:     org.apache.openjpa.util.java.util.HashMap.proxy
